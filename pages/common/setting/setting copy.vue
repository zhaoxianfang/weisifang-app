<template>
    <view class="container">
        ...
        <tui-actionsheet :show="showActionSheet" tips="退出登录会清除您的登录信息，确认退出吗？" :item-list="itemList" :mask-closable="true"
            color="#9a9a9a" :size="26" :is-cancel="true" @click="itemClick" @cancel="closeActionSheet">
        </tui-actionsheet>
    </view>
</template>
