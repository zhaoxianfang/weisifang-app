<template>
    <view class="container">
        ...
        <form :report-submit="true" @submit="formLogin">
            <view class="tui-login-from">
                ...
                <view class="tui-line-cell tui-top28">
                    ...
                    <input placeholder-class="tui-phcolor" v-model="password" class="tui-input" name="password"
        ...
        <!-- #ifdef APP-PLUS -->
        <!--底部分享弹窗-->
        <tui-bottom-popup backgroundColor="#f6f6f6" :zIndex="1002" :maskZIndex="1001" :show="popupShow"
            @close="showLogin">
            <view class="tui-share">
                ...
                <scroll-view scroll-x style="padding-right:20rpx" class="tui-mt">
                    <view class="tui-share-top">
                        <view class="tui-share-item" :class="[otherLoginType.length-1===index?'tui-item-last':'']"
                            v-for="(item,index) in otherLoginType" :key="index" @tap="chooseLoginType(item)">
