...
<template>
    ...
    <tui-divider :gradual="true">第三方账号登录</tui-divider>
		<view class="wsf-other-login col">
			<view class="wsf-sdk-login" @tap="otherLogin('qq')"><tui-icon name="qq" color="#5677fc" :size="80" unit="rpx"></tui-icon></view>
      <view class="wsf-sdk-login" @tap="otherLogin('sina')"><tui-icon name="sina" color="#F4A460" :size="80" unit="rpx"></tui-icon></view>
		</view>
	</view>
</template>
<script>
...
export default {
	data() {
		return {
			title: '威四方 欢迎您！', //填写logo或者app名称，也可以用：欢迎回来
			second: 60, //默认60秒
